...
with DAG(
    ...
    transfer_data_csv = S3ToTeradataOperator(
        ...
        s3_source_key="/s3/td-usgs-public.s3.amazonaws.com/CSVDATA/09394500/2018/",
    ...
    transfer_data_json = S3ToTeradataOperator(
        ...
        s3_source_key="/s3/td-usgs-public.s3.amazonaws.com/JSONDATA/09394500/2018/",
    ...
    transfer_data_parquet = S3ToTeradataOperator(
        ...
        s3_source_key="/s3/td-usgs-public.s3.amazonaws.com/PARQUETDATA/09394500/2018/",
