...
DAG from upstream DAG. Upstream DAG will pause and resume only once the downstream DAG has finished running"""
...
with DAG(
    dag_id="example_upstream_dag_wait_for_downstream",
    max_active_runs=1,
    max_active_tasks=3,
    catchup=False,
